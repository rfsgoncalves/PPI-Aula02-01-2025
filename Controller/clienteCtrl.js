//Essa classe será responsável por controlar as requisições
//HTTP para clientes (API REST disponibilizando clientes)

//Requisições HTTP GET, POST, PUT, DELETE que manipulam os clientes
...
export default class ClienteCtrl {
    ...
    alterar(requisicao, resposta){
        if ((requisicao.method === 'PUT' || requisicao.method === 'PATCH') 
            ...
            if (cpf && nome && endereco && bairro 
                && cidade  && uf && telefone && email ){
                const cliente = new Cliente(cpf, nome, endereco, bairro,
                                            cidade, uf, telefone, email);    
